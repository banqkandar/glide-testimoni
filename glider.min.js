! function (e) {
    ...
    var e = window.Glider = function (e, t) {
            ...
            for (o.ele = e, o.ele.classList.add("glider"), (o.ele._glider = o).opt = Object.assign({}, {
                    slidesToScroll: 1,
                    slidesToShow: 1,
                    resizeLock: !0,
                    duration: .5,
                ...
                }, t), o.animate_id = o.page = o.slide = 0, o.arrows = {}, o._opt = o.opt, o.track = document.createElement("div"), o.track.className = "glider-track", o.ele.appendChild(o.track); 1 !== o.ele.children.length;) o.track.appendChild(o.ele.children[0]);
            o.init(), o.resize = o.init.bind(o, !0), o.event(o.ele, "add", {
    ...
    return t.init = function (e, t) {
        ...
        if (t)
            for (var o = 0; o < t.length; ++o) {
                var i = t[o];
                if (window.innerWidth > i.breakpoint) return e.breakpoint !== i.breakpoint && (e.opt = Object.assign({}, e._opt, i.settings), e.breakpoint = i.breakpoint, !0)
            }
        ...
        var r = this,
            ...
            n = function () {
                ...
                r.ele.scrollLeft = r.ele.scrollLeft + (t - r.ele.scrollLeft) * r.opt.easing(0, e, 0, 1, o), e < o && l === r.animate_id ? window.requestAnimationFrame(n) : (r.ele.scrollLeft = t, i && i.call(r))
            };
        ...
        var o = this;
        o.breakpoint && o._opt.responsive.forEach(function (e) {
            e.breakpoint === o.breakpoint && (e.settings = Object.assign({}, e.settings, t))
        }), o.breakpoint && !e || (o._opt = Object.assign({}, o._opt, t)), o.opt = Object.assign({}, o.opt, t)
    }, t.destroy = function () {
        var e = this,
            t = e.ele.cloneNode(!0),
            o = function (t) {
                t.removeAttribute("style"), t.classList.forEach(function (e) {
                    /^glider/.test(e) && t.classList.remove(e)
                })
            };
        t.children[0].outerHTML = t.children[0].innerHTML, o(t), [].forEach.call(t.getElementsByTagName("*"), o), e.ele.parentNode.replaceChild(t, e.ele), e.event(window, "remove", {
            resize: e.resize
        }), e.emit("destroy")
    }, t.emit = function (e, t) {
